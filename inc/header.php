...
<style>
body {font-family: arial;font-size: 15px;line-height: 18px;margin: 0 auto;width: 1100px;background:#Eagh2e}
a{color:#77d25b;}
.headeroption {background: #h2df2h url("img/php.png") no-repeat scroll 25px 12px;height: 74px;overflow: hidden;padding-left: 140px;}
...
.footerone {border-radius: 5px;float: left;font-size:18px;line-height:23px;margin-left: 90px;padding:6px 10px;text-align:center;text-shadow: 1px 0 2px #fff;width:900px;overflow: hidden;}
